...
MENU_STRUCTURE = [
    ...
    },
    {
        "nombre": "Selección",
        "icono": "search",
        "ruta": "/seleccion/requisiciones",
        "orden": 3,
        "permisos": "ver_empleados,crear_empleado",
        "hijos": [
            {
    ...
    },
    {
        ...
        "hijos": [
            ...
            },
            {
                ...
                "icono": "pen-tool",
                "ruta": "/vinculacion/firmas",
                "orden": 2,
                "permisos": "ver_empleados",
            },
            {
                "nombre": "Bundles Documentales",
                "icono": "package",
                "ruta": "/vinculacion/bundles",
                "orden": 3,
                "permisos": "ver_empleados",
            },
        ],
    ...
    {
        "nombre": "Cese y Liquidación",
        "icono": "user-minus",
        "ruta": "/cese/terminaciones",
        "orden": 10,
        "permisos": "ver_empleados,gestionar_usuarios",
        "hijos": [
            {
            ...
            },
            {
                ...
                "icono": "receipt",
                "ruta": "/cese/liquidaciones",
                "orden": 2,
                "permisos": "ver_empleados",
            },
            {
                "nombre": "Flujo de Salida",
                "icono": "log-out",
                "ruta": "/cese/flujo",
                "orden": 3,
                "permisos": "ver_empleados",
    ...
    },
    {
        ...
        "hijos": [
            ...
            },
            {
                "nombre": "CAP / CPE",
                "icono": "list-tree",
                "ruta": "/organizacion/registros/cap",
                "orden": 2,
                "permisos": "gestionar_usuarios",
            },
            {
    ...
    },
    {
        "nombre": "Compensación",
        "icono": "scale",
        "ruta": "/compensacion/ccf",
        "orden": 12,
        "permisos": "gestionar_usuarios",
        "hijos": [
            {
                "nombre": "CCF (Ley 30709)",
                "icono": "scale",
                "ruta": "/compensacion/ccf",
                "orden": 1,
                "permisos": "gestionar_usuarios",
    ...
    },
    {
        "nombre": "Políticas",
        "icono": "shield-alert",
        "ruta": "/politicas/admin",
        "orden": 14,
        "permisos": "gestionar_usuarios,ver_empleados",
        "hijos": [
            {
                "nombre": "Gestor de Políticas",
                "icono": "file-cog",
                "ruta": "/politicas/admin",
                "orden": 1,
                "permisos": "gestionar_usuarios",
            },
            {
                ...
                "ruta": "/politicas/acuses",
                "orden": 2,
                "permisos": "ver_empleados",
            },
            {
                "nombre": "Plan Estratégico RRHH",
                "icono": "target",
                "ruta": "/politicas/estrategico",
                "orden": 3,
                "permisos": "gestionar_usuarios",
            },
            {
                "nombre": "Plan de Dotación",
                "icono": "trending-up",
                "ruta": "/politicas/dotacion",
                "orden": 4,
                "permisos": "gestionar_usuarios",
            },
            {
                "nombre": "Matriz de Cumplimiento",
                "icono": "shield-check",
                "ruta": "/politicas/cumplimiento",
                "orden": 5,
                "permisos": "gestionar_usuarios",
            },
        ],

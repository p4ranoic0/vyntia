...
| L3.7 | `payroll` app | `vyntia/L3.7-payroll-app` | Mover `Remuneracion`/`ConfiguracionUit` + `services/{planilla_calculo,descuento_masivo}.py`. NO incluye motor multi-régimen (eso es Vyntia Pay sub-proyecto D) | ~14 | Medio | L3.4 | ⏳ NEXT |

...
| L3.8 | `time_off` app | `vyntia/L3.8-timeoff-app` | Mover modelos `Vacaciones` (5 modelos en 1 archivo: ConfiguracionVacaciones, PeriodoVacacional, SolicitudVacaciones, GoceVacaciones, HistorialSolicitudVacaciones) + 5 vacation services. Split `VacationRequest`+`VacationBalance` deferido a L3.10 | ~18 | Alto (5 services) | L3.4 | ⏳ NEXT |

...
| L3.9 | `onboarding` app | `vyntia/L3.9-onboarding-app` | Mover `OnboardingEmpleado` (último modelo en `app_rrhh/models/`) + `services/onboarding_service.py` (581 líneas). Sub-PR final de extracción antes del rename masivo en L3.10 | ~10 | Bajo | L3.4 | ⏳ NEXT |

...
| L3.3 | `organization` app | `vyntia/L3.3-organization-app` | Mover `Area`/`Ubicacion`/`ConfiguracionEmpresa`/`Sistema` a `apps/api/apps/organization/` con FKs lazy | ~12 | Medio | L3.1, L3.2 | ⏳ NEXT |

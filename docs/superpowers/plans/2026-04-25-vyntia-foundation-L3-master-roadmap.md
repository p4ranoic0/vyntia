...
| L3.5 | `contracts` app | `vyntia/L3.5-contracts-app` | `ContratosAdendas` → split a `Contract` + `ContractAmendment`, `DatosLaborales` → `EmploymentData`. Cambio de modelo de datos | ~16 | Alto (model split + data migration) | L3.4 | ⏳ NEXT |

...
| **L4.8** | payroll feature migration | `vyntia/L4.8-feature-payroll` | Move `pages/remuneraciones/*` (8 pages) → `features/payroll/pages/`. Move `services/payrollService.ts` → `features/payroll/services/`. Move `hooks/useRemuneraciones.ts` → `features/payroll/hooks/`. Update routes for /remuneraciones/. ~40-60 import updates | ~18 | Medio | L4.1 | ⏳ NEXT |

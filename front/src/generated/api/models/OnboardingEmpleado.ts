 ...
 */
export type OnboardingEmpleado = {
    readonly onboarding_id: number;
    empleado: number;
    readonly empleado_nombre: string;
    readonly empleado_documento: string;
    usuario: number;
    readonly usuario_username: string;
    ...
    readonly progreso_porcentaje: string;
    readonly items_pendientes: string;
    readonly documentos_pendientes: string;
    ...
    readonly fecha_completado: string | null;
};

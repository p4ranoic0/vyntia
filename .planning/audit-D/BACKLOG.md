...
| 7 | **[D.1b] Squash legacy payroll migrations `0001_initial` + `0002_*`** — run Django squashmigrations to collapse into single clean initial; delete originals | backend | deuda | P0 | D.1 | 5 | 1h | INV § 1 migration disposition |
